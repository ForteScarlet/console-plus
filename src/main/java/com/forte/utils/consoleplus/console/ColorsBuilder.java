package com.forte.utils.consoleplus.console;

import com.forte.utils.consoleplus.console.colors.BackGroundColorTypes;
import com.forte.utils.consoleplus.console.colors.ColorTypes;
import com.forte.utils.consoleplus.console.colors.FontColorTypes;
...
public class ColorsBuilder {
    ...
    public ColorsBuilder color(FontColorTypes fontColor){
        return color(fontColor.getColorIndex());
    }
    public ColorsBuilder color(BackGroundColorTypes backGroundColor){
        return color(backGroundColor.getColorIndex());
    }
    ...
    public Colors build(){
        flush();
        ColorTypes[] colors = this.colors.stream().map(this::toColorTypes).toArray(ColorTypes[]::new);
